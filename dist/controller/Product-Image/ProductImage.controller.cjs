...
var ProductImage_controller_exports = {};
__export(ProductImage_controller_exports, {
  default: () => ProductImageController
});
module.exports = __toCommonJS(ProductImage_controller_exports);
...
app.use(import_express4.default.static(import_path2.default.join(__dirname, "..", "Tke_Front_end")));
routes_default(app);
app.get("/", (req, res) => {
