...
var addImageProductFileLocal_service_exports = {};
__export(addImageProductFileLocal_service_exports, {
  addImageFile: () => addImageFile
});
module.exports = __toCommonJS(addImageProductFileLocal_service_exports);
...
async function addImageFile(id, req, res) {
  try {
    ...
    import_fs5.default.writeFileSync(filePath, req.file.buffer);
    await productImageService6.create({
      imagem: fileName,
      productId: id
    });
