...
var getImageProductFileLocal_service_exports = {};
__export(getImageProductFileLocal_service_exports, {
  getImageFile: () => getImageFile
});
module.exports = __toCommonJS(getImageProductFileLocal_service_exports);
...
async function getImageFile(id) {
  ...
  const filePath = import_path6.default.join(imagesDir, import_path6.default.basename(relativePath));
  if (!import_fs5.default.existsSync(filePath)) {
    throw new Error("Arquivo f\xEDsico n\xE3o encontrado");
  }
  const file = import_fs5.default.readFileSync(filePath);
