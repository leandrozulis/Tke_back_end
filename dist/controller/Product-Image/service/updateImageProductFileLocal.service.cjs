...
var updateImageProductFileLocal_service_exports = {};
__export(updateImageProductFileLocal_service_exports, {
  updateImageFile: () => updateImageFile
});
module.exports = __toCommonJS(updateImageProductFileLocal_service_exports);
...
async function updateImageFile(id, req, res) {
  try {
    ...
    const result = oldImageExists ? await productImageService6.update(id, data) : await productImageService6.create({ ...data, productId: id });
