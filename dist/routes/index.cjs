...
var imagesDir = process.env.VERCEL ? "/tmp/imagens" : import_path.default.join(process.cwd(), "src", "imagens");
if (!import_fs.default.existsSync(imagesDir)) {
  import_fs.default.mkdirSync(imagesDir, { recursive: true });
}
app.use("/imagens", import_express2.default.static(imagesDir));
var __filename = (0, import_url.fileURLToPath)(import_meta.url);
var __dirname = (0, import_path2.dirname)(__filename);
app.use(import_express2.default.static(import_path.default.join(__dirname, "..", "Tke_Front_end")));
routes_default(app);
app.get("/", (req, res) => {
  res.sendFile(import_path.default.join(__dirname, "..", "Tke_Front_end", "index.html"));
});
app.get("*", (req, res) => {
  res.sendFile(import_path.default.join(__dirname, "..", "Tke_Front_end", "index.html"));
});
...
async function removeImageFile(id) {
  ...
  const filePath = import_path3.default.join(imagesDir, fileName);
...
var router2 = import_express3.default.Router();
...
// dist/routes/productImageRouter.js
var router3 = import_express4.default.Router();
